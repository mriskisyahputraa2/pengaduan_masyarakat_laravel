            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.formLogin') }}" class="btn btn-outline-purple ">Petugas</a>
                        </li>
                    </ul>
                    @endauth
                </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">&copy; 2023 - Muhammad Rizki Syahputra</p>
    </div>
</div>
{{-- end footer --}}
